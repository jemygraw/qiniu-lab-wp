...
{
    public partial class SimpleUploadOverwriteExistingFile : PhoneApplicationPage
    {
        private Stream uploadFileStream;
        private string uploadFileKey;
        private HttpManager httpManager;
        private string upTokenUrl;
        public SimpleUploadOverwriteExistingFile()
        {
            InitializeComponent();
            this.upTokenUrl = string.Format("{0}{1}", Config.API_HOST, Config.SIMPLE_UPLOAD_OVERWRITE_EXISTING_FILE_PATH);
        ...
        private void uploadFile()
        {
            ...
            postArgs.Params.Add("key", this.uploadFileKey);
